    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 pt-24">
        <div className="container mx-auto px-4">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-8 text-white text-center">Projects</h1>
            <div className="bg-black/30 backdrop-blur-sm p-8 rounded-lg">
              <p className="text-gray-300 text-center">My projects will be displayed here soon.</p>
            </div>
          </motion.div>
        </div>
      </div>
